...
var suit = "";
var deckArr = [];
var cardBack = "<img class='img-thumbnail' src='http://www.wopc.co.uk/images/subjects/tarot/rider-waite/pam-roses-lilies-back.jpg'>";
...
function pastPresentFuture() {
  ...
  for (var b = 1; b <= 3; b++) {
    ...
    $("#td-display-name-" + b).html("<h4><b>" + deck[rand].displayName + "</b></h4>");
